...
oxidize_install() {
    ...
    cargo install --git "https://git.alatreon.org/strawberries/here"
...
handle_arch() {
    ...
    chezmoi init --apply https://git.alatreon.org/strawberries/dotfiles.git
    ...
    cargo install --git "https://git.alatreon.org/strawberries/dotswitch"
